...
public class ArgCheckUtil {
    ...
    public static <T> T checkArg(T arg, boolean condition, String argName) {
        ...
        throw new IllegalArgumentException(String.format(Locale.US, "Illegal argument for %s.", argName));
    }
     ...
     */
    public static boolean checkTimingCurveObjectValidity(float[][][] timingCurves, int keyFrameQuantity) {

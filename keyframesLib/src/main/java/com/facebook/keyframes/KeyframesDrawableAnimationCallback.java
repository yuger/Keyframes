...
public abstract class KeyframesDrawableAnimationCallback {
     ...
     */
    public static KeyframesDrawableAnimationCallback create(FrameListener listener, KFImage face) {
        if (hasChoreographer()) {
            return new FrameCallbackFaceAnimationCallback(listener, face.getFrameRate(), face.getFrameCount());
        } else {
            return new RunnableFaceAnimationCallback(listener, face.getFrameRate(), face.getFrameCount());
        }
    }
    ...
    private static class FrameCallbackFaceAnimationCallback extends KeyframesDrawableAnimationCallback implements Choreographer.FrameCallback {
        ...
        private FrameCallbackFaceAnimationCallback(FrameListener listener, int frameRate, int frameCount) {
    ...
    private static class RunnableFaceAnimationCallback extends KeyframesDrawableAnimationCallback implements Runnable {
        ...
        private RunnableFaceAnimationCallback(FrameListener listener, int frameRate, int frameCount) {
            super(listener, frameRate, frameCount);

...
public class KFGradient {
    ...
    public KFGradient(KFGradientColor colorStart, KFGradientColor colorEnd) {
        mStartGradient = KeyFramedGradient.fromGradient(ArgCheckUtil.checkArg(colorStart, colorStart != null, COLOR_START_JSON_FIELD), START);
        mEndGradient = KeyFramedGradient.fromGradient(ArgCheckUtil.checkArg(colorEnd, colorEnd != null, COLOR_END_JSON_FIELD), END);
    }

...
public class KFFeatureDeserializer {
    static final AbstractListDeserializer<KFFeature> LIST_DESERIALIZER = new AbstractListDeserializer<KFFeature>() {
        @Override
        ...
        while (reader.hasNext()) {
            ...
            switch (name) {
                ...
                case KFFeature.FEATURE_ANIMATIONS_JSON_FIELD:
                    builder.featureAnimations = KFAnimationDeserializer.LIST_DESERIALIZER.readList(reader);
                    break;

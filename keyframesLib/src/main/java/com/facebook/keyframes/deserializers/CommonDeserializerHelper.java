...
public class CommonDeserializerHelper {
     ...
     */
    public static final AbstractListDeserializer<String> STRING_LIST_DESERIALIZER = new AbstractListDeserializer<String>() {
        @Override
     ...
     */
    private static final AbstractListDeserializer<Float> FLOAT_LIST_DESERIALIZER = new AbstractListDeserializer<Float>() {
        @Override
     ...
     */
    private static final AbstractListDeserializer<List<Float>> FLOAT_LIST_2D_DESERIALIZER = new AbstractListDeserializer<List<Float>>() {
        @Override
     ...
     */
    private static final AbstractListDeserializer<List<List<Float>>> FLOAT_LIST_3D_DESERIALIZER = new AbstractListDeserializer<List<List<Float>>>() {
        @Override

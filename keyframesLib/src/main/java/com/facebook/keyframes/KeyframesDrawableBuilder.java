...
public class KeyframesDrawableBuilder {
    ...
    public class ExperimentalFeatures {
        ...
        public ExperimentalFeatures withParticleFeatureConfigs(Pair<String, Pair<Drawable, Matrix>>... configs) {
            mParticleFeatureConfigs = new HashMap<>();
            for (Pair<String, Pair<Drawable, Matrix>> config : configs) {
                mParticleFeatureConfigs.put(config.first, new KeyframesDrawable.FeatureConfig(config.second.first, config.second.second));
            }
